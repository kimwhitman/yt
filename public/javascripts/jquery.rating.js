...
/*# AVOID COLLISIONS #*/
	...
	$.rating = {
		...
		overwrite: false,					// set to true when you'll be rendering input[type=radio] via ajax.
	...
	$.fn.rating = function(instanceSettings){
		...
		processed = {}; // a hash "input_name" --> "true|false" to determine if an input has been processed.
