...
Scenario: Non-account holder submits story
  ...
  And I fill in "user_story[email]" with "email@domain.local"
...
Scenario: A submitted story gets approved
  Given A User Story has been submitted and approved from "email@domain.local"
  Then a story submission approval should be sent to "email@domain.local"
